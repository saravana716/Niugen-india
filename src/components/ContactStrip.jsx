      ...
      <div className="contact-col main-col">
        <div className="icon-wrapper">
          <svg width="56" height="56" viewBox="0 0 64 64" fill="none">
            ...
            <path d="M22 36V28a10 10 0 0 1 20 0v8" stroke="var(--color-primary)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
            <rect x="18" y="32" width="8" height="14" rx="4" stroke="var(--color-primary)" strokeWidth="3" fill="#fff" />
            <rect x="38" y="32" width="8" height="14" rx="4" stroke="var(--color-primary)" strokeWidth="3" fill="#fff" />
            <path d="M22 44v3a4 4 0 0 0 4 4h4" stroke="var(--color-primary)" strokeWidth="3" strokeLinecap="round" />
            <circle cx="35" cy="51" r="2.5" fill="var(--color-primary)" />
          </svg>
        </div>
      ...
      <div className="contact-col">
        <div className="icon-wrapper">
          <svg width="56" height="56" viewBox="0 0 64 64" fill="none">
            ...
            <path d="M24.8 22.1c-.8-1.7-1.6-1.8-2.3-1.8h-2c-.7 0-1.8.3-2.7 1.2S15 24 15 28s3.4 8 3.9 8.7 5.9 9.3 14.3 12.6c7 2.8 8.4 2.3 9.9 2.1 1.5-.2 4.7-1.9 5.4-3.8.7-1.8.7-3.4.5-3.8-.2-.3-.7-.5-1.5-.9s-4.7-2.3-5.4-2.6c-.7-.3-1.2-.5-1.7.3s-2.1 2.6-2.6 3.1c-.5.5-1 .6-1.7.3-4.2-2.1-7.4-4.8-10.2-9.4-.5-.8-.1-1.2.3-1.6.4-.3.8-.9 1.2-1.4.4-.5.5-.8-1.4.3-.5.1-1-.1-1.4s-1.8-4.4-2.6-6.1z" fill="var(--color-primary)" />
          </svg>
        </div>
        <div className="contact-info">
