        ...
        <section className="pd-main-content">
          <div className="container">
            ...
            <div className="pd-content-row">
              <div className="pd-col-left">
                <div className="pd-section">
                  ...
                  <div className="pd-masterplan-img">
                    <img src={project.image || '/master-plan.png'} alt="Master Plan" />
                  </div>
                </div>
              </div>
              <div className="pd-col-right">
            ...
            <div className="pd-content-row pd-content-row-3">
              <div className="pd-col-left" style={{ display: 'flex', flexDirection: 'row', gap: '40px' }}>
                ...
                <div className="pd-section" style={{ flex: '1' }}>
                  ...
                  <div className="location-flex" style={{ display: 'flex', gap: '20px' }}>
              ...
              <div className="pd-col-right">
                <div className="pd-contact-card">
                  <h4>A Smart Investment for a Bright Future</h4>
                  <p>Own a plot today and be part of a growing community.</p>
                  <button className="btn-brown-full">ENQUIRE NOW &rarr;</button>
                  <button className="btn-white-full">BOOK SITE VISIT</button>
